function initialize() {
  ...
  //   origin_place_name = JSON.stringify(origin_place.name)
    ...
    if (!origin_place.geometry) {
      ...
      document.getElementById('origin_coordinates').value = origin_place.geometry.location;
      ...
      map = new google.maps.Map(document.getElementById('map'), {
         ...
         .then((response) =>{
           if(response.results[0]){
             ...
             document.getElementById('origin_coordinates').value = `(${latitude}, ${longitude})`
           }
           else{
  ...
  function onDestinationChanged() {
    ...
    if (!destination_place.geometry) {
      ...
      document.getElementById('destination_coordinates').value = destination_place.geometry.location;
